      ...
      <div className="profit-workspace">
        <div className="profit-visual">
          <div className="value-block total-m">
            ...
            <div className="block-body">
              <div className="split-arrow down" />
              ...
              <div className="split-branches">
                <div className="branch p-branch">
                  ...
                  >
                    ...
                    <h3>Lợi nhuận Doanh nghiệp</h3>
                    <span className="symbol">
                      p<sub>doanh nghiệp</sub>
                    </span>
                    <p>
                      Phần Alpha Corp giữ lại để đắp vào vốn tự có, thưởng cho ban giám đốc hoặc tái sản
                      xuất.
                    </p>
                  </motion.div>
                </div>
        ...
        <div className="profit-theory">
          <div className="theory-card">
            ...
            <p>
              Lợi tức thực chất là <strong>một phần của giá trị thặng dư</strong> mà nhà tư bản đi vay
              (Alpha Corp) phải nhường lại cho nhà tư bản cho vay (Ngân hàng) để được quyền sử dụng vốn.
            </p>
            <div className="equation">0 &lt; z &lt; p&#x0304;</div>
            <p className="text-sm text-muted mt-2">
              Lợi tức luôn lớn hơn 0 và nhỏ hơn tỷ suất lợi nhuận bình quân.
            </p>
          </div>
            ...
            <ul className="crisis-list">
              ...
              <li>
                ...
                <div>
                  ...
                  <span>Dù không có doanh thu, lãi vay (z) vẫn cộng dồn hằng ngày (lãi mẹ đẻ lãi con).</span>
                </div>
              </li>
              <li>
                <AlertCircleIcon />
                <div>
                  <strong>p âm</strong>
                  <span>
                    Doanh nghiệp phải lấy vốn tự có (hoặc đi vay nóng) để trả lãi, dẫn đến cạn vốn và phá
                    sản.
                  </span>
                </div>
              </li>
