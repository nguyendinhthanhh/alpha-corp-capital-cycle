...
export const aiUsageRows = [
  {
    date: '15/06/2026',
    tool: 'ChatGPT (GPT-4o)',
    purpose: 'Đề xuất cấu trúc storytelling, lên khung học thuật của tuần hoàn tư bản và soạn thảo ngân hàng câu hỏi quiz thô.',
    prompt: 'Tóm tắt các giai đoạn tuần hoàn tư bản theo giáo trình MLN122, đề xuất các câu hỏi quiz trắc nghiệm và liên hệ thực tế với trường hợp Alpha Corp.',
    output: 'Bản thảo đề xuất cấu trúc bài học, tóm tắt lý thuyết (T, H, SX, H\', T\') và 32 câu hỏi trắc nghiệm baseline.',
    revision: 'Nhóm rà soát kỹ lưỡng, chỉnh lại các thuật ngữ lý luận của Mác-Lênin cho chuẩn xác và đồng nhất với giáo trình chính thống.',
    source: 'Giáo trình Kinh tế chính trị Mác - Lênin.',
    owner: 'Nhóm nội dung',
  },
  {
    date: '18/06/2026',
    tool: 'Canva AI (Design)',
    purpose: 'Tạo dựng layout giao diện học tập Canva-style trực quan, thiết kế hệ màu sắc (HSL palette) và layout các khối card trong Không gian học tập.',
    prompt: 'Generate visual style guide for a modern, glassmorphic education dashboard with neon teal, gold accents, dark mode, and smooth micro-interactions.',
    output: 'Mẫu thiết kế visual card, bảng mã màu neon mờ, phong cách glassmorphic và gợi ý tỷ lệ grid tối ưu.',
    revision: 'Chuyển đổi giao diện thiết kế từ Canva thành mã nguồn CSS, tinh chỉnh thuộc tính shadow và backdrop-filter để hoạt động mượt mà trên browser.',
    source: 'Canva AI visual design specifications.',
    owner: 'Nhóm thiết kế',
  },
  {
    date: '20/06/2026',
    tool: 'Antigravity (AI Coding Agent)',
    purpose: 'Lập trình logic React, phát triển thuật toán tính điểm thích ứng (Adaptive mastery engine), và tối ưu code linter.',
    prompt: 'Refactor Quiz.jsx và dashboard học tập, thiết kế hệ thống tính điểm mastery dựa trên lịch sử làm bài và gợi ý từ AI Coach.',
    output: 'Mã nguồn React/JSX hoàn chỉnh cho quiz và dashboard, cài đặt state hooks bền vững và cơ chế local storage profile.',
    revision: 'Kiểm thử tính đúng đắn của logic tính điểm thích ứng, sửa lỗi biến không sử dụng (linter errors), và bảo đảm responsive hoàn hảo.',
    source: 'Tài liệu kỹ thuật React và Vite.',
    owner: 'Nhóm frontend',
  },
];
